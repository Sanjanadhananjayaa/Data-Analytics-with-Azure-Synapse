...
1. When the setup script has finished running, in the Azure portal, go to the **analytics-*xxxxxxx*** resource group that it created, and notice that this resource group contains your Synapse workspace, a Storage account for your data lake, an Apache Spark pool and a Dedicated SQL pool.
